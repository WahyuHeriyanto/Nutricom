...
//        verticalArrangement = Arrangement.Center,
        ...
        Text("Ubah Kata Sandi", fontSize = 30.sp, fontWeight = FontWeight.Bold)
        Spacer(modifier = Modifier.height(24.dp))
        Box(modifier = Modifier.fillMaxWidth()){
            Text(
                text = "Masukan email pengguna yang terdaftar untuk menerima link permintaan ubah kata sandi",
                fontSize = 16.sp,
                ...
                FirebaseAuth.getInstance().sendPasswordResetEmail(email)
                    .addOnCompleteListener { task ->
                        ...
                        if (task.isSuccessful) {
                            ...
                            errorMessage = task.exception?.message ?: "Terjadi kesalahan.Silakan coba lagi"
                            successMessage = null
                        }
                    }
            },
