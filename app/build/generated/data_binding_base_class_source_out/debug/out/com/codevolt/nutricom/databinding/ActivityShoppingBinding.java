...
public final class ActivityShoppingBinding implements ViewBinding {
  ...
  private ActivityShoppingBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout appBar,
  ...
  public static ActivityShoppingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityShoppingBinding((CoordinatorLayout) rootView, appBar, fab, toolbar,
          toolbarLayout);
    }
